...
wrapper2 = Label(window)

'''img = PhotoImage(file = "circuit.png");
labe = Label(wrapper1, image = img)
...
label1 = Label(myframe, text = ' Welcome Dear Gamer!            ', font = ('Times New Roman', 15), fg = 'green')
label1.pack()
...
tick = Checkbutton(wrapper2, text = 'Accept Privacy Policy', font = ('Times New Roman', 10), command = check_checkbox, variable = chk, onvalue = 1, offvalue = 0)
...
frame1 = Frame(wrapper2, width = 300, bg = 'white')
frame1.grid(row = 8, column = 0)

lab3 = Label(frame1, text = '                        ', font = ('Arial', 10), fg = 'blue')
lab3.grid(row = 1, column = 0)
btn1 = Button(frame1, text = 'Next', command = Next, bg = 'green', fg = 'white')
btn1['state'] = 'disabled'
btn1.grid(row = 1, column = 1, padx = 50, pady = 5)
btn2 = Button(frame1, text = 'Cancel', command = cancel, bg = 'red', fg = 'white')
btn2.grid(row = 1, column = 2, padx = 50, pady = 5)
lab4 = Label(frame1, text = '                        ', font = ('Arial', 10), fg = 'blue')
